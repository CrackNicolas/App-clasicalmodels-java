...
public class TablaLineaDeProductos extends javax.swing.JFrame {
    
    public TablaLineaDeProductos() {
        initComponents();
        this.setExtendedState(6);
        Personalizacion.Personalizar.Tabla(Tabla,2);
    }
    ...
    private void initComponents() {
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Producto en linea", "Descripcion", "Dscripcion Html"
            }
        ));
