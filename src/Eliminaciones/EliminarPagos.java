...
public class EliminarPagos extends javax.swing.JFrame{
    public String x,y,z;
    ...
    private void initComponents() {
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Numero cliente", "Verificacion numero", "Fecha pago", "Cantidad"
            }
        ));
    ...
    private void BotonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEliminarActionPerformed
        ...
        if(Tabla.getSelectedRow()>=0){
            ...
            z= datos.getValueAt(Tabla.getSelectedRow(),3).toString();
            Controlador.Controlador_Elimi_Pagos.Eliminar();
        }else{
            javax.swing.JOptionPane.showMessageDialog(null," Antes de eliminar seleccione el pago");
        }
    ...
    private void LupaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LupaActionPerformed
        if(Buscar.getText().equals("Buscar...")){
            Buscar.setText("");
            Controlador.Controlador_Elimi_Pagos.Mostrar();
        }else{
            Controlador.Controlador_Elimi_Pagos.Mostrar();
        }
