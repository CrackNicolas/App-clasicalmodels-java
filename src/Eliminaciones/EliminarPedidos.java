...
public class EliminarPedidos extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nro de orden", "Fecha orden", "Fecha requerida", "Fecha envio", "Estado", "Comentarios", "Nro cliente"
            }
        ));
    ...
    private void BotonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEliminarActionPerformed
        ...
        if(Tabla.getSelectedRow()>=0){
            ...
            Controlador.Controlador_Elimi_Pedidos.Eliminar();
        }else{
            javax.swing.JOptionPane.showMessageDialog(null," Antes de eliminar seleccione el pedido");
        }
