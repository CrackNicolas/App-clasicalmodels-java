...
public class EliminacionEmpleados extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nro empleado", "Apellido", "Nombre", "Estencion", "Reportes", "Codigo de oficina", "Titulo", "Email"
            }
        ));
    ...
    private void BotonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEliminarActionPerformed
        ...
        if(Tabla.getSelectedRow()>=0){
            ...
            Controlador.Controlador_Elimi_Empleado.Eliminar();
        }else{
            javax.swing.JOptionPane.showMessageDialog(null," Antes de eliminar seleccione un empleado");
        }
