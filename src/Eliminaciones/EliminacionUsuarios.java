...
public class EliminacionUsuarios extends javax.swing.JFrame{
    ...
    private void BotonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEliminarActionPerformed
        ...
        if(Tabla.getSelectedRow()>=0){
            ...
            Controlador.Controlador_Elimi_Usuarios.Eliminar();
        }else{
            javax.swing.JOptionPane.showMessageDialog(null," Antes de eliminar seleccione un usuario");
        }
