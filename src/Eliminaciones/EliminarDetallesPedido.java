...
public class EliminarDetallesPedido extends javax.swing.JFrame{
    private String x,y,z,w;
    
    public EliminarDetallesPedido(){
    ...
    private void initComponents() {
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nro de orden", "Codigo producto", "Cantidad pedida", "Precio por unidad"
            }
        ));
    ...
    private void BotonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonEliminarActionPerformed
        ...
        if(Tabla.getSelectedRow()>=0){
            x = datos.getValueAt(Tabla.getSelectedRow(),0).toString();
            y = datos.getValueAt(Tabla.getSelectedRow(),1).toString();
            z = datos.getValueAt(Tabla.getSelectedRow(),2).toString();
            w = datos.getValueAt(Tabla.getSelectedRow(),3).toString();
            Controlador.Controlador_Elimi_DetallesPed.Eliminar();
        }else{
            javax.swing.JOptionPane.showMessageDialog(null," Antes de eliminar seleccione el detalle del pedido");
        }
